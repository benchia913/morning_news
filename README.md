...
Python script and GitHub Actions workflow that fetches finance-focused news from RSS feeds, optionally runs them through an LLM (Claude) for a human-sounding summary and trading intuition, and sends the result by email and/or Telegram on a fixed schedule.
